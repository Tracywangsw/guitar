    ...
    function($) {
        ...
        Vitrine.prototype = {
            ...
            layout: function() {
                ...
                var span1_normal = "margin-top: 45%;left: 28%;font-size: 1.3rem;position: absolute; color: #fff";

                var span1_center = "margin-top: 15%;left: 20%;font-size: 1.1rem; position: absolute; color: #fff";

                 var span2_normal ="margin-top: 24%;left: 20%;font-size: 0.8rem;position: absolute;color: #fff; display:none"; 

                var span2_center = "margin-top:24%;left: 15%;width: 72%;font-size: 0.9rem;position:absolute;color:#fff;display:block";
                ...
                for (var i = 0; i < 5; i++) {
                    if (positions[i] !== null) {
                        ...
                        if (i == 2){
                            this.$showItems[i][0].childNodes[1].children[0].style.cssText =span1_center;
                            this.$showItems[i][0].childNodes[1].children[1].style.cssText =span2_center;
                        }else{
                            this.$showItems[i][0].childNodes[1].children[0].style.cssText =span1_normal;
                            this.$showItems[i][0].childNodes[1].children[1].style.cssText =span2_normal;
                        }
