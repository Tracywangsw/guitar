...
! function(e, n, t) {
	...
	function o() {
		...
		for (var f in x)
			if (x.hasOwnProperty(f)) {
				...
				for (r = s(n.fn, "function") ? n.fn() : n.fn, o = 0; o < e.length; o++) i = e[o], a = i.split("."), 1 === a.length ? Modernizr[a[0]] = r : (!Modernizr[a[0]] || Modernizr[a[0]] instanceof Boolean || (Modernizr[a[0]] = new Boolean(Modernizr[a[0]])), Modernizr[a[0]][a[1]] = r), y.push((r ? "" : "no-") + a.join("-"))
			}
	}
	...
	function d(e, n, t) {
		var r;
		for (var o in e)
			if (e[o] in n) return t === !1 ? e[o] : (r = n[e[o]], s(r, "function") ? p(r, t || n) : r);
		return !1
	}
	...
	function v(e, n, r, o) {
		...
		for (var p, d, c, v, h, g = ["modernizr", "tspan"]; !L.style;) p = !0, L.modElem = i(g.shift()), L.style = L.modElem.style;
		for (c = e.length, d = 0; c > d; d++)
			if (v = e[d], h = L.style[v], l(v, "-") && (v = a(v)), L.style[v] !== t) {
				if (o || s(r, "undefined")) return f(), "pfx" == n ? v : !0;
				try {
					L.style[v] = r
				} catch (y) {}
				if (L.style[v] != h) return f(), "pfx" == n ? v : !0
			}
		return f(), !1
	}
	...
	Modernizr.addTest("fullscreen", !(!A("exitFullscreen", n, !1) && !A("cancelFullScreen", n, !1))), C.testAllProps = g, Modernizr.addTest("cssanimations", g("animationName", "a", !0)), Modernizr.addTest("cssfilters", function() {
		if (Modernizr.supports) return g("filter", "blur(2px)");
		var e = i("a");
		return e.style.cssText = w.join("filter:blur(2px); "), !!e.style.length && (n.documentMode === t || n.documentMode > 9)
		...
		return e
	}), Modernizr.addTest("csstransitions", g("transition", "all", !0)), o(), r(y), delete C.addTest, delete C.addAsyncTest;
...
! function(t, e, i, n) {
	function r() {
		for (var t, e = ["transform", "msTransform", "webkitTransform", "mozTransform", "oTransform"], n = 0; n < e.length; n++)
			if ("undefined" != typeof i.body.style[e[n]]) {
				t = e[n];
				break
			}
		switch (t) {
	...
	function s(t) {
		...
		return r.style.color = t, i.body.appendChild(r), n = e.getComputedStyle(r).color, i.body.removeChild(r), n
	}
			...
			if (t.hasOwnProperty(e)) {
				...
				switch (e) {
					...
					case "gridMargin":
						...
						break;
					case "fullscreen":
						"boolean" != typeof i && (t[e] = w[e]), Modernizr.fullscreen || (t[e] = !1);
						break;
					case "easing":
						"string" != typeof i && (t[e] = w[e]);
						break;
	...
	function a(e, i) {
		var n = this;
		this.$el = t(e), this.isLoaded = !1, this.grid = null, this.settings = t.extend({}, w, i), c(this.settings), "chroma" != this.settings.color && (this.settings.color = s(this.settings.color)), null == y && (y = new l, this.$el.append("<span class='chrg-loadicon chrgi-image'></span>"), setTimeout(function() {
			n.$el.find(".chrg-loadicon").remove()
		}, 100)), this._init()
	}

	function l() {
		this.colorThief = new u, this.settings = null, this.isOpen = !1, this.isFullscreen = !1, this.curItem = null, this.curGallery = null, this.init()
	}
	var h = function(t) {
		this.canvas = i.createElement("canvas"), this.context = this.canvas.getContext("2d"), i.body.appendChild(this.canvas), this.width = this.canvas.width = t.width, this.height = this.canvas.height = t.height, this.context.drawImage(t, 0, 0, this.width, this.height)
	};
	...
	if (u.prototype.getColor = function(t, e) {
			...
			"undefined" == typeof e && (e = 10), ("undefined" == typeof i || 1 > i) && (i = 10);
			for (var n, r, s, o, c, a = new h(t), l = a.getImageData(), u = l.data, g = a.getPixelCount(), f = [], p = 0; g > p; p += i) n = 4 * p, r = u[n + 0], s = u[n + 1], o = u[n + 2], c = u[n + 3], c >= 125 && (r > 250 && s > 250 && o > 250 || f.push([r, s, o]));
			var m = d.quantize(f, e),
				v = m ? m.palette() : null;
			return a.removeCanvas(), v
		}, !g) var g = {
		map: function(t, e) {
			var i = {};
	...
	var d = function() {
			...
			function e(t) {
				...
				return {
					...
					peek: function(t) {
						return n || e(), void 0 === t && (t = i.length - 1), i[t]
					},
					pop: function() {
						return n || e(), i.pop()
					},
			...
			function i(t, e, i, n, r, s, o) {
				var c = this;
				c.r1 = t, c.r2 = e, c.g1 = i, c.g2 = n, c.b1 = r, c.b2 = s, c.histo = o
			}
			...
			function r(e) {
				...
				return e.forEach(function(e) {
					n = e[0] >> l, r = e[1] >> l, s = e[2] >> l, i = t(n, r, s), c[i] = (c[i] || 0) + 1
				}), c
			}
			...
			function s(t, e) {
				...
				return t.forEach(function(t) {
					n = t[0] >> l, r = t[1] >> l, s = t[2] >> l, o > n ? o = n : n > c && (c = n), a > r ? a = r : r > h && (h = r), u > s ? u = s : s > g && (g = s)
				}), new i(o, c, a, h, u, g, e)
			}
			...
			function o(e, i) {
				...
				if (i.count()) {
					...
					if (c == r)
						for (a = i.r1; a <= i.r2; a++) {
							for (u = 0, l = i.g1; l <= i.g2; l++)
								for (h = i.b1; h <= i.b2; h++) d = t(a, l, h), u += e[d] || 0;
							f += u, p[a] = f
						} else if (c == s)
							for (a = i.g1; a <= i.g2; a++) {
								for (u = 0, l = i.r1; l <= i.r2; l++)
									for (h = i.b1; h <= i.b2; h++) d = t(l, a, h), u += e[d] || 0;
								f += u, p[a] = f
							} else
								for (a = i.b1; a <= i.b2; a++) {
									for (u = 0, l = i.r1; l <= i.r2; l++)
										for (h = i.g1; h <= i.g2; h++) d = t(l, h, a), u += e[d] || 0;
									f += u, p[a] = f
								}
			...
			return i.prototype = {
				...
				count: function(e) {
					...
					if (!i._count_set || e) {
						...
						for (r = i.r1; r <= i.r2; r++)
							for (s = i.g1; s <= i.g2; s++)
								for (o = i.b1; o <= i.b2; o++) index = t(r, s, o), c += n[index] || 0;
						i._count = c, i._count_set = !0
					}
					return i._count
				},
				copy: function() {
				...
				avg: function(e) {
					...
					if (!i._avg || e) {
						...
						for (s = i.r1; s <= i.r2; s++)
							for (o = i.g1; o <= i.g2; o++)
								for (c = i.b1; c <= i.b2; c++) l = t(s, o, c), r = n[l] || 0, h += r, g += r * (s + .5) * u, d += r * (o + .5) * u, f += r * (c + .5) * u;
				...
				contains: function(t) {
					var e = this,
						i = t[0] >> l;
					return gval = t[1] >> l, bval = t[2] >> l, i >= e.r1 && i <= e.r2 && gval >= e.g1 && gval <= e.g2 && bval >= e.b1 && bval <= e.b2
				}
			}, n.prototype = {
				push: function(t) {
					this.vboxes.push({
				...
				nearest: function(t) {
					for (var e, i, n, r = this.vboxes, s = 0; s < r.size(); s++) i = Math.sqrt(Math.pow(t[0] - r.peek(s).color[0], 2) + Math.pow(t[1] - r.peek(s).color[1], 2) + Math.pow(t[2] - r.peek(s).color[2], 2)), (e > i || void 0 === e) && (e = i, n = r.peek(s).color);
					return n
				},
				forcebw: function() {
					var t = this.vboxes;
	...
	t.extend(a.prototype, {
		_init: function() {
			var e = this;
			this.$el.hasClass("chroma-gallery") || this.$el.addClass("chroma-gallery"), this.$el.show(), setTimeout(function() {
				var i = 0;
				e._createGrid(), e._setEvents(), e.grid.find("img").imagesLoaded().always(function() {
					e.isLoaded = !0, e.$el.trigger("chrg.load")
				}).progress(function(r, s) {
					var c = t(s.img),
						a = e.settings.lazyLoad ? 150 * i : 0;
					if (i++, s.isLoaded) {
						var l = c.attr("alt") !== n ? c.attr("alt").substring(0, 144) : "";
						c.parent().attr("data-isloaded", "true"), c.parent().find("p").append(l), setTimeout(function() {
							c.parent().css({
								opacity: "1"
							}), e.grid.masonry("layout")
						}, a)
					} else c.parent().find("p").append("<span class='chrgi-image'></span><br>" + o(c.attr("src")) + " failed to load"), c.parent().attr("data-isloaded", "false").css({
						cursor: "default"
					}), c.css({
						height: "200px",
						opacity: "0"
		...
		_getColumnWidth: function(t) {
			...
			return e = 400 >= i ? 2 : i / this.settings.maxColumns >= 200 ? Math.min(this.settings.maxColumns, t) : Math.floor(i / 200), this.settings.gridMargin > 0 ? 100 / e * ((i - e * this.settings.gridMargin) / i) : 100 / e
		},
		_createGrid: function() {
			var t = this;
			if (this.settings.items) {
				var e = this._getColumnWidth(this.settings.items.length);
				this.$el.html("<div class='chrg-grid'></div>"), this.grid = this.$el.find(".chrg-grid");
				...
				this.$el.append("<div class='chrg-grid'></div>"), this.grid = this.$el.find(".chrg-grid"), this.$el.find("img").wrap("<div class='chrg-item chrg-no-select' style='width:" + e + "%; margin-bottom:" + this.settings.gridMargin + "px;'></div>").parent().append("<div class='chrg-description'><p></p></div>"), this.grid.append(this.$el.find(".chrg-item"))
			}
			this.grid.masonry({
		...
		_reloadGrid: function() {
			...
			this.grid.find(".chrg-item").css("width", t + "%"), this.grid.masonry("layout")
		},
		_setEvents: function() {
			var i = this;
			this.grid.find(".chrg-item").on("click", function() {
				i.openImg(t(this).index())
		...
		init: function() {
			m.append("<div class='chroma-screen'><div class='chrg-bg'></div><div class='chrg-wrap'><div class='chrg-content'><div class='chrg-imgwrap'></div></div><div class='chrg-ui'><button class='chrgi-close chrg-no-select'></button><button class='chrg-fullscreen chrgi-maximize chrg-no-select'></button><button class='chrgi-next chrg-no-select'></button><button class='chrgi-previous chrg-no-select'></button> </div></div></div>"), this.$screen = m.find(".chroma-screen"), this.$imgWrap = this.$screen.find(".chrg-imgwrap"), this.$fullscreenBtn = this.$screen.find(".chrg-fullscreen"), this.$loader = this.$screen.find(".chrg-loader"), this.$ui = this.$screen.find(".chrg-ui"), this.$bg = this.$screen.find(".chrg-bg"), this.lock = !1, this.setEvents()
		},
		setEvents: function() {
			var t = this;
			this.$screen.find(".chrgi-close").on("click", function(e) {
				e.stopPropagation(), t.closeImg()
			...
			}), Modernizr.touchevents || this.$screen.find(".chrg-wrap").on("click", function() {
				t.closeImg()
			}), Modernizr.fullscreen && this.$fullscreenBtn.on("click", function(e) {
				e.stopPropagation(), t.toggleFullscreen()
			})
		},
		...
		resizeImgWrap: function() {
			...
			t = {
				width: e.w * i,
				height: e.h * i
			}, t[b + "transform"] = Modernizr.csstransforms3d ? "translate3d(" + n.x + "px," + n.y + "px,0) scale(1)" : "translate(" + n.x + "px," + n.y + "px) scale(1)", this.$imgWrap.css(t)
		},
		loadImg: function(t) {
			var e = this,
				i = new Image;
			Modernizr.cssanimations && this.$loader.show(), i.onload = function() {
				e.$imgWrap.append(this), Modernizr.cssanimations && e.$loader.hide()
			}, i.onerror = function() {
				e.$loader.hide()
		...
		getRGBColor: function(t) {
			if ("chroma" == this.settings.color) {
				if (t.data("color") === n) {
					...
					return e = i && 3 == i.length ? "rgb(" + i[0] + "," + i[1] + "," + i[2] + ")" : "rgb(0,0,0)", t.attr("data-color", e), e
				}
				return t.data("color")
			}
		...
		openImg: function() {
			if (!this.lock) {
				...
				this.$imgWrap.html(""), this.settings.fullscreen ? this.$fullscreenBtn.show() : this.$fullscreenBtn.hide(), t = Math.min(s.width / this.curItem.width(), s.height / this.curItem.height()), e = {
					...
					width: e.width,
					height: e.height
				}), Modernizr.csstransforms3d ? this.$imgWrap.css(b + "transform", "translate3d(" + e.x + "px," + e.y + "px,0) scale(" + 1 / t + ")") : this.$imgWrap.css(b + "transform", "translate(" + e.x + "px," + e.y + "px) scale(" + 1 / t + ")"), this.settings.dof && (m.wrapInner("<div class='chrg-dof-body'></div>"), this.$screen.appendTo(m)), e.x = (p.width() - e.width) / 2, e.y = (p.height() - e.height) / 2, this.$imgWrap.addClass("chrg-animation chrg-easing-" + this.settings.easing), this.$imgWrap.append(o), this.$screen.show(), this.isOpen = !0, setTimeout(function() {
					i.curItem.css("visibility", "hidden"), i.$ui.css("opacity", .01), i.$ui.css("opacity", 1), i.$bg.css("opacity", .01), i.$bg.css({
						opacity: i.settings.screenOpacity,
						"background-color": r
					}), i.settings.dof && m.find(".chrg-dof-body").addClass("chrg-dof-effect"), Modernizr.cssanimations && i.$loader.show(), Modernizr.csstransforms3d ? i.$imgWrap.css(b + "transform", "translate3d(" + e.x + "px," + e.y + "px,0) scale(1)") : i.$imgWrap.css(b + "transform", "translate(" + e.x + "px," + e.y + "px) scale(1)"), setTimeout(function() {
						i.lock = !1, i.curGallery.trigger("chrg.openImg"), i.loadImg(o)
					}, v + 50)
				}, 80)
			}
		},
		closeImg: function() {
			if (this.isOpen && !this.lock) {
				...
				this.$imgWrap.find("img:nth-child(2)").hide(), this.$ui.css("opacity", ""), this.$bg.css("opacity", ""), this.settings.dof && m.find(".chrg-dof-body").contents().unwrap(), setTimeout(function() {
					Modernizr.csstransforms3d ? t.$imgWrap.css(b + "transform", "translate3d(" + n.x + "px," + n.y + "px,0) scale(" + e + ")") : t.$imgWrap.css(b + "transform", "translate(" + n.x + "px," + n.y + "px) scale(" + e + ")"), setTimeout(function() {
						t.curItem.css("visibility", ""), t.$imgWrap.attr("class", "chrg-imgwrap"), t.curGallery.trigger("chrg.closeImg"), setTimeout(function() {
							t.curItem = null, t.$screen.hide(), Modernizr.fullscreen && t.isFullscreen && t.toggleFullscreen(), t.curGallery = null, t.isOpen = !1, t.lock = !1
						}, 50)
					}, v + 50)
				}, 50)
			}
		...
		next: function() {
			if (!this.lock) {
				...
				this.goTo(n), t.curGallery.trigger("chrg.next")
			}
		},
		swipeNext: function() {},
		prev: function() {
			if (!this.lock) {
				...
				var t = this,
					...
					n = this.curGallery.find(".chrg-item:eq(" + i + ")");
				this.goTo(n), t.curGallery.trigger("chrg.prev")
			}
		},
		swipePrev: function() {},
		goTo: function(t) {
			...
			e = Math.min(c.width / t.width(), c.height / t.height()), i = {
				width: t.width() * e,
				height: t.height() * e,
				...
				width: i.width,
				height: i.height
			}, n[b + "transform"] = Modernizr.csstransforms3d ? "translate3d(" + i.x + "px," + i.y + "px,0) scale(1)" : "translate(" + i.x + "px," + i.y + "px) scale(1)", this.$imgWrap.removeClass("chrg-animation"), r.curItem.css("visibility", "visible"), r.$imgWrap.css(n), r.$imgWrap.html(""), r.$imgWrap.append(s), r.$bg.css({
				"background-color": o
			}), r.curItem = t, r.curItem.css("visibility", "hidden"), r.loadImg(s), setTimeout(function() {
				r.$imgWrap.addClass("chrg-animation"), r.lock = !1
			}, 50)
		}
	}), t.fn[f] = function(e) {
		var i = arguments;
		...
		if ("string" == typeof e && "_" !== e[0] && "init" !== e) {
			...
			return this.each(function() {
				...
				n instanceof a && "function" == typeof n[e] && (r = n[e].apply(n, Array.prototype.slice.call(i, 1))), "destroy" === e && t.data(this, "plugin_" + f, null)
			}), r !== n ? r : this
		}
	}
