...
class CourseCommentsControllerTest < ActionController::TestCase
  ...
  test "should create course_comment" do
    assert_difference('CourseComment.count') do
      post :create, course_comment: { content: @course_comment.content, course_id: @course_comment.course_id, user_id: @course_comment.user_id }
    end
  ...
  test "should update course_comment" do
    patch :update, id: @course_comment, course_comment: { content: @course_comment.content, course_id: @course_comment.course_id, user_id: @course_comment.user_id }
    assert_redirected_to course_comment_path(assigns(:course_comment))
  end
