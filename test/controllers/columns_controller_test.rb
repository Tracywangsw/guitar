...
class ColumnsControllerTest < ActionController::TestCase
  ...
  test "should create column" do
    assert_difference('Column.count') do
      post :create, column: { description: @column.description, name: @column.name, video_link: @column.video_link }
    end
  ...
  test "should update column" do
    patch :update, id: @column, column: { description: @column.description, name: @column.name, video_link: @column.video_link }
    assert_redirected_to column_path(assigns(:column))
  end
