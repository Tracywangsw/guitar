...
class CollectsControllerTest < ActionController::TestCase
  ...
  test "should create collect" do
    assert_difference('Collect.count') do
      post :create, collect: { course_id: @collect.course_id, info: @collect.info, user_id: @collect.user_id }
    end
  ...
  test "should update collect" do
    patch :update, id: @collect, collect: { course_id: @collect.course_id, info: @collect.info, user_id: @collect.user_id }
    assert_redirected_to collect_path(assigns(:collect))
  end
